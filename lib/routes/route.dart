...
class Routes {
  ...
  static Route _errorRoute([String message = 'Please Login To See Your eSIM and if you order new one you will have to wait 1-10min']) {
    return MaterialPageRoute(builder: (_) {
      return Scaffold(
        ...
        body:Column(
          ...
          children: <Widget>[
            Image.asset('assets/images/notice.png',height:100,width:100, fit: BoxFit.fill),
